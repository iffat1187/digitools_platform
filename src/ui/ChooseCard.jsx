const ChooseCard = ({ details }) => {
	return (
		<div className='card  bg-base-100 w-full shadow-lg p-4'>
			{/* step */}
			<div className='flex justify-center  w-12.5 h-12.5 rounded-full bg-linear-to-r from-[#5743ec] to-[#9B5CF6] ml-auto'>
			...
			<div className='card-body py-12'>
				<div className='bg-[#f0e9fe] rounded-full mx-auto w-25 h-25 flex items-center mb-5'>
