				...
				return (
					...
					>
						<div className='flex gap-7 items-center justify-center'>
							<div className='w-12.5 h-12.5 flex items-center justify-center bg-base-200 rounded-full shadow-2xl '>
								<img src={cart.icon} alt={cart.plan} />
							</div>

							<div>
								<h2 className='text-xl font-bold'>{cart.plan}</h2>
